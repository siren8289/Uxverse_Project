...
import TopBar_1 from "../common_components/TopBar_1";
...
const FontFamily = {
  notoSansKRMedium: "NotoSansKR-Medium", // 프로젝트에서 쓰는 실제 폰트명에 맞춰 필요시 수정
};
const FontSize = {
  size_14: 14,
  size_16: 16,
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: Color.colorGray100 },
  scrollContent: { paddingHorizontal: HORIZONTAL_PADDING, paddingBottom: 100 },

  /* 유저 카드 */
  userCard: { marginTop: 50, width: "100%", position: "relative" },
  userName: {
    marginTop: 55,
  ...
  /* 진행바 */
  progressWrap: { marginTop: 25, width: "100%" },
  barTrack: { width: BAR_WIDTH, height: 11 },
  barFill: {
    position: "absolute",
    top: 0,
    left: 0,
  ...
  /* Personal 카드 */
  personalWrap: { marginTop: 17, width: "100%" },
});
