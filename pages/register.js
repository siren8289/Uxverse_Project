...
import IconCheck1 from "../assets/vector.svg";
        ...
        <View style={[styles.statusBarIphone, styles.homeIndicatorPosition]}>
          <View style={styles.frame}>
            ...
            <View style={[styles.levels, styles.timeFlexBox]}>
              <IconCellular style={styles.cellularConnectionIcon} width={19} height={12} />
              <IconWifi style={styles.wifiIcon} width={17} height={12} />
